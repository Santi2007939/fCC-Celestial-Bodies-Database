...
--
-- Name: worldcup; Type: DATABASE; Schema: -; Owner: your_user
--

CREATE DATABASE worldcup WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C.UTF-8' LC_CTYPE = 'C.UTF-8';


ALTER DATABASE worldcup OWNER TO your_user;
...
--
-- Name: games; Type: TABLE; Schema: public; Owner: your_user
--
...
ALTER TABLE public.games OWNER TO your_user;

--
-- Name: games_game_id_seq; Type: SEQUENCE; Schema: public; Owner: your_user
--
...
ALTER TABLE public.games_game_id_seq OWNER TO your_user;

--
-- Name: games_game_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: your_user
--
...
--
-- Name: teams; Type: TABLE; Schema: public; Owner: your_user
--
...
ALTER TABLE public.teams OWNER TO your_user;

--
-- Name: teams_team_id_seq; Type: SEQUENCE; Schema: public; Owner: your_user
--
...
ALTER TABLE public.teams_team_id_seq OWNER TO your_user;

--
-- Name: teams_team_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: your_user
--
...
--
-- Name: games game_id; Type: DEFAULT; Schema: public; Owner: your_user
--
...
--
-- Name: teams team_id; Type: DEFAULT; Schema: public; Owner: your_user
--
...
--
-- Data for Name: games; Type: TABLE DATA; Schema: public; Owner: your_user
--
...
--
-- Data for Name: teams; Type: TABLE DATA; Schema: public; Owner: your_user
--
...
--
-- Name: games_game_id_seq; Type: SEQUENCE SET; Schema: public; Owner: your_user
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: your_user
--
...
--
-- Name: games games_pkey; Type: CONSTRAINT; Schema: public; Owner: your_user
--
...
--
-- Name: teams teams_name_key; Type: CONSTRAINT; Schema: public; Owner: your_user
--
...
--
-- Name: teams teams_pkey; Type: CONSTRAINT; Schema: public; Owner: your_user
--
...
--
-- Name: games games_opponent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: your_user
--
...
--
-- Name: games games_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: your_user
--
